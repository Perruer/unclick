// This file is copied from HashiCorp Terraform v0.12.31
// (configs/hcl2shim/flatmap.go) and is licensed under the Mozilla Public
// License 2.0: https://mozilla.org/MPL/2.0/. Only the package name changed.

// Package shim converts between Terraform's legacy flatmap state format and
// cty values.
package shim
