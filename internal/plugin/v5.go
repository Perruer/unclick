...
func (p *v5) listResource(ctx context.Context, typeName string, config cty.Value, configTy cty.Type, includeResource bool, limit int64, objectTy cty.Type) ([]ListedResource, []Diagnostic, error) {
