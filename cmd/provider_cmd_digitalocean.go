...
import (
	digitalocean_terraforming "github.com/Perruer/unclick/providers/digitalocean"
...
func init() {
	registerProvider(newCmdDigitalOceanImporter, newDigitalOceanProvider)
}
