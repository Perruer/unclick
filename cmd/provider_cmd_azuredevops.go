...
import (
	azuredevops "github.com/Perruer/unclick/providers/azuredevops"
...
func init() {
	registerProvider(newCmdAzureDevOpsImporter, newAzureDevOpsProvider)
}
