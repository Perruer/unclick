...
```
GRAFANA_AUTH=api_token GRAFANA_URL=https://stack.grafana.net ./unclick import grafana -r=grafana_dashboard // Import with Grafana API token
GRAFANA_AUTH=username:password GRAFANA_URL=https://stack.grafana.net ./unclick import grafana -r=grafana_dashboard // Import with HTTP basic auth
```
