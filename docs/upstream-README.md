> **Note:** this is the original README of [Terraformer](https://github.com/GoogleCloudPlatform/terraformer), kept for reference. Unclick continues this project; see the [main README](../README.md).
